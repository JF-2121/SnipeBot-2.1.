  ...
  try {
    ...
    $("article.aditem").each((_, element) => {
      try {
        ...
        const item: ScrapedItem & { cleanTitle?: string; sellerUsername?: string; sellerAvatar?: string; condition?: string; publishedAt?: string; description?: string; images_array?: string[]; main_image_url?: string; totalPrice?: number; buyerProtectionFee?: number } = {
          id,
          title: cleanTitle,
          price,
          size,
