import { Scraper, SearchOptions, ScrapedItem } from "./types.js";
 ...
 */
const PRIMARY_SCRAPER: Scraper = vintedScraper;
const BACKUP_SCRAPER: Scraper = kleinanzeigenScraper;
 ...
 */
export function startVintedOnlyWindow(): void {
 ...
 */
function isVintedOnlyWindowActive(): boolean {
  if (!isInVintedOnlyWindow) return false;
 ...
 */
export function setRateLimit(durationMs: number): void {
 ...
 */
async function searchVintedWithRetry(
  query: string,
 ...
 */
export const SCRAPERS: Scraper[] = [PRIMARY_SCRAPER, BACKUP_SCRAPER];
